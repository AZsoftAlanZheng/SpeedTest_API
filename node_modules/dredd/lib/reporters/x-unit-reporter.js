...
var EventEmitter, XUnitReporter, file, fs, fsExtra, htmlencode, logger, pathmodule, prettifyResponse,
  ...
  XUnitReporter.prototype.configureEmitter = function(emitter) {
    emitter.on('start', (function(_this) {
      return function(rawBlueprint, callback) {
        return fsExtra.mkdirp(pathmodule.dirname(_this.path), function(err) {
          if (!err) {
