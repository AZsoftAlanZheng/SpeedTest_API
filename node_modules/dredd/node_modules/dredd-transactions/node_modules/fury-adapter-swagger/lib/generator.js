...
function bodyFromSchema(schema, payload, parser) {
  ...
  try {
    ...
    if (typeof body !== 'string') {
      if ((0, _mediaType.isFormURLEncoded)(contentType)) {
        // Form data
        // TODO: check for arrays etc.
        body = _querystring2.default.stringify(body);
      } else if ((0, _mediaType.isMultiPartFormData)(contentType)) {
        var boundary = (0, _mediaType.parseBoundary)(contentType);
        var content = '';

        _lodash2.default.forEach(body, function (value, key) {
          content += '--' + boundary + '\r\n';
